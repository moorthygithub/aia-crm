  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/add-student-delivery/:id" element={<StudentAddDelivery />} />
        ...
        <Route path="/view-student-enquiry/:id" element={<ViewStudentEquiry />} />
        <Route path="/edit-student-course/:id" element={<EditStudentCourse />} />
        <Route path="/view-course/:id" element={<ViewCourse />} />
        <Route path="/edit-student-delivery/:id" element={<EditStudentDelivery />} />
